...
<form action="../login/Registro_curso.php" method="POST" enctype="multipart/form-data">
<center><h1>REGISTRO DE CURSOS</h1></center>
<div class="form-group">
  <p>	
    NOMBRE DEL CURSO  <input type="text" class="form-control" name="nombre_curso"  required/>
    DESCRIPCIÓN DEL CURSO <input type="text" class="form-control" name="descripcion"  required/>
    <div class="row">
      <div class="col">
...
<div class="col">
	MODALIDAD <input type="text" class="form-control" name="modalidad"  required/>
</div>
</div>
<div class="row">
      <div class="col">
...
<div class="col">
	LUGAR  <input type="text" class="form-control" name="lugar"  required/>
</div>
 <div class="col">
  COSTO <input type="number" class="form-control" name="costo" min="0" required/></div>
</div>
<div class="row">
      <div class="col">
	HORA <input type="time" class="form-control" name="hora" min="0" required/></div>
  <div class=" col">
	FECHA DE INICIO <input type="date" class="form-control" name="fecha" value="2019-10-22" min="2019-01-01" required=""></div>
  <div class=" col">
  FECHA DE TERMINACION <input type="date" class="form-control" name="fechafin" value="2019-10-22" min="2019-01-01" required=""></div>
  <div class="col">
  Cupo<input type="number" class="form-control" name="cupo" min="0" required/>
  </div>
  </div>
  <center>
